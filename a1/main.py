...
if __name__ == '__main__':
    ...
    parser.add_argument('--disable_tt', action='store_true', help='If added, disables the transposition table')
    ...
    parser.add_argument('--time_limit', type=float, default=None, help='Set the time limit')
